...
{
    public partial class OCC_处置备案_Print : Form
    {
        public OCC_处置备案_Print()
        {
            InitializeComponent();
        }
        ...
        {
            //
            OCC_处置备案_Print _PrintForm = null;
            //
            ...
            public void Print(OCC_处置备案_Print APrintForm)
            {
            ...
            public void SetPrintParam(string APrinterName = "")
            {
                ...
                _printDoc.DefaultPageSettings.Landscape = false;//获取或设置一个值，该值指示是横向还是纵向打印该页。如果页面应横向打印，则为 true；反之，则为 false。默认值由打印机决定。
                ...
                _printDoc.DefaultPageSettings.Margins.Top = Convert.ToInt32(120 / 2.54);
