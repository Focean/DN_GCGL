...
namespace GCGL_Client.OCC
{
    public partial class OCC_配置申请_Editor : Form
    {
        ...
        public void Editor_Add()
        {
            ...
            {
                Get_Freeze();
                this.dgvList.Columns["预算单位名称"].Visible = false;
                //
        ...
        public void Editor_See(string ACardCode)
        {
            ...
            Lb_一般公务冻结编制数.Visible = false;
            lbl公务冻结数.Visible = false;
        ...
        private void Get_Freeze()
        {
            try
            {
                ...
                mdel.单位编码 = AppServer.LoginUnitCode;
        ...
        private void btn修改_Click(object sender, EventArgs e)
        {
            ...
            using (var form = new OCC_配置申请_Editor_MX())
            {
                form.Editor_Mod(row, C_执法CarNum, C_公务CarNum);
                if (form.ShowDialog() == DialogResult.OK)
                {
                    //更新数据
