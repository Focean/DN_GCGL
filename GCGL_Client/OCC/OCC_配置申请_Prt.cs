...
{
    public partial class OCC_配置申请_Prt :Form
    {
        public OCC_配置申请_Prt()
        {
            InitializeComponent();
            //
            //this.nudPaperWidth.Value = 290;
            //this.nudPaperHeight.Value = 210;
            //
        }
        ...
        class Prt_Printer
        {
            ...
            public void Print(OCC_配置申请_Prt APrintForm)
            {
            ...
            public void SetPrintParam(string APrinterName = "")
            {
                ...
                _printDoc.DefaultPageSettings.Margins.Top = Convert.ToInt32(180 / 2.54);
