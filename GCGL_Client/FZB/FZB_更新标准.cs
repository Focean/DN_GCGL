...
{
    public partial class FZB_更新标准 : Form
    {
        public FZB_更新标准()
        {
            InitializeComponent();
            ...
            //
            if (AppServer.UserQxMenuList.Rows.Contains("010502"))
            {
        ...
        private void BZ_更新标准_Load(object sender, EventArgs e)
        {
        ...
        private void DataBinding_GridView(int ACurrRowIndex)
        {
            try
            {
                ...
                DataSet db = AppServer.wcfClient.CMN_车辆更新标准_List(ref model);
        ...
        private void btn新增_Click(object sender, EventArgs e)
        {
            ...
            using (var form = new FZB_更新标准_Editor())
            {
                form.Editor_Add();
        ...
        private void btn删除_Click(object sender, EventArgs e)
        {
            ...
            if (iRowID == 0) return;
            if (!AppServer.DialogMsg("确认要删除当前车辆更新标准吗？", "删除确认")) return;
            //
